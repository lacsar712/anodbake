...
function renderSnapshot(snap) {
  ...
  document.getElementById("pressure").textContent = snap.pitline.steam_pressure_psi.toFixed(0);
  document.getElementById("mw").textContent = snap.pitline.output_mw.toFixed(1);
  document.getElementById("anodepit-level").textContent = snap.anodepit.level_percent.toFixed(1);
  document.getElementById("burner").textContent = snap.pitfire.burner_phase;
  document.getElementById("o2").textContent = snap.pitfire.excess_o2_pct.toFixed(2);
  trendData.push(snap.pitline.steam_pressure_psi);

...
import (
	...
	"github.com/lacsar712/anodbake/internal/app"
	"github.com/lacsar712/anodbake/internal/web"
	"github.com/lacsar712/anodbake/internal/web/api"
)
...
func main() {
	...
	go func() {
		log.Printf("anodbake listening on %s (unit %s)", cfg.ListenAddr, application.UnitID())
